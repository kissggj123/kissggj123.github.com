...
<body>
    ...
    <div class="list closed">
        <ul>
          ...
          <!------>
            ...
            <li><a rel="nofollow" href="https://www.youtube.com" target="_blank"><i class="iconfont icon-youtube" style="color: #ff0000;"></i>Youtube</a></li>
          <!------>
            <li class="title"><i class="iconfont icon-shipin"></i>看看看</li>
            ...
            <li><a rel="nofollow" href="http://www.btbtdy.me/" target="_blank"><i class="iconfont icon-movies" style="color: #067;"></i>BT电影</a></li>
            ...
            <li><a rel="nofollow" href="https://soundcloud.com" target="_blank"><i class="iconfont icon-music" style="color:#09e;"></i>soundcloud</a></li>
          <!------>
            <li class="title"><i class="iconfont icon-gouwuche"></i> 买买买</li>
            ...
            <li><a rel="nofollow" href="https://www.amazon.com/" title="你最爱的美亚" target="_blank"><i class="iconfont icon-amazon" style="color: #f83e3e;"></i>美亚</a></li>
    ...
    <div id="content">
        ...
        <div class="foot">© 2019-<?php echo date("Y") ?> Based on <a href="https://www.menglolita.com/">YumikoAnime</a>  Inspired by hotoke</div>
    </div>
</body>
</html>
